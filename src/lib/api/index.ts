...
import type { EventApi } from "./client";

export { ApiNotConfiguredError, ApiRequestError } from "./client";
export type { EventApi } from "./client";
 ...
 */
export function getApi(): EventApi {
