...
import { RegistrationStage } from "@/components/registration/registration-stage";
          ...
          <RegistrationStage
            ...
            backLink={
              <Link
                ...
                className="ev-on-dark-focus inline-flex shrink-0 items-center gap-1.5 rounded-md pt-1 text-[0.875rem] text-[var(--ev-on-dark-muted)] transition-colors hover:text-[var(--ev-on-dark)]"
              >
